...
- Fixed Datepicker CSS for Tribe Events Calendar

## [1.1.10] - 2026-03-02

### Fixed

- Fixed Button CSS for Tribe Events Calendar

## [1.1.9] - 2026-02-03

### Added

- Ascept Ratio Support for Embed Privacy

## [1.1.8] - 2025-12-15

### Fixed

- Removed global style dependency

## [1.1.7] - 2025-12-10

### Changed

- Removed styles_global.php enqueue

## [1.1.6] - 2025-12-03

### Fixed

- Replaced .edit-post-visual-editor class with .editor-styles-wrapper in admin stylesheets

## [1.1.5] - 2025-12-03

### Fixed

- Fixed action enqueue_block_editor_assets

## [1.1.4] - 2025-07-22

### Fixed

- Fixed thickbox link for images with PDF attachment links

## [1.1.3] - 2025-07-07

### Fixed

- Fixed max-width for empty embeds
- Fixed thickbox link for images with PDF attachment links
...
- Disable Options Pages in free ACF version

## [1.0.31] - 2024-01-25

### Fixed

- Adjusted Tribe Events More Link CSS

## [1.0.30] - 2023-12-18

### Changed

- Adjusted viewport meta tag

...
function inis_b_custom_color_image($pageID) {
	...
	if (isset($tribe_customizer['global_elements']['accent_color'])) {
		...
		$output .= "\t.tribe-events .tribe-events-c-ical__link:before  { background-image: url(\"data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12'%3E%3Cpath d='M6 1v10m5-5H1' fill='none' fill-rule='evenodd' stroke='%23" . $accent_color_pure . "' stroke-linecap='square' stroke-width='1.5'/%3E%3C/svg%3E\"); }";
		...
		$output .= "\t.tribe-block__events-link .tribe-block__btn--link a { color: " . $tribe_customizer['global_elements']['accent_color'] . "; }";
		$output .= "\t.tribe-block__events-link .tribe-block__btn--link img { visibility: hidden; }";
		$output .= "\t.tribe-block__events-link .tribe-block__btn--link a { background-image: url(\"data:image/svg+xml,%3Csvg width='26' height='15' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M12.6 7.576H9.227v1.732H12.6v3.742a.2.2 0 0 1-.198.2H1.918a.199.199 0 0 1-.198-.2V5.092c0-.111.089-.201.198-.201h10.485a.2.2 0 0 1 .198.2v2.485zm5.755-3.86l-.066.067L17.16 4.93l2.601 2.646H14.33V2.843a.797.797 0 0 0-.79-.803h-.74c-.034.003-.32.004-.856.004V.804a.797.797 0 0 0-.79-.804c-.446 0-.8.36-.8.803v1.24H3.992V.804A.797.797 0 0 0 3.202 0c-.447 0-.8.36-.8.803v1.24h-.796c-.041 0-.058-.003-.075-.003H.79c-.436 0-.79.36-.79.803V3.91c0 .055.006.108.016.16v8.978a.36.36 0 0 0-.008.082v1.067c0 .443.354.803.79.803h.74a12956.843 12956.843 0 0 1 12.01 0c.437 0 .79-.36.79-.803V13.13a.36.36 0 0 0-.008-.082v-3.74h5.43l-2.599 2.643 1.192 1.215L23 8.44l-4.645-4.725z' fill='%23" . $accent_color_pure . "' fillRule='evenodd'/%3E%3C/svg%3E\"); background-repeat:no-repeat; background-position: 15px  center; }";
		$output .= "\t.tribe-events .tribe-events-c-search__input-control--keyword-focus .tribe-events-c-search__input, .tribe-events .tribe-events-c-search__input-control--keyword .tribe-events-c-search__input:focus { background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg width='20' height='20' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M20 18.711l-6.044-6.044a7.782 7.782 0 0 0 1.688-4.845c0-2.089-.822-4.044-2.288-5.533C11.866.822 9.91 0 7.822 0S3.778.822 2.29 2.289A7.801 7.801 0 0 0 0 7.822c0 2.09.822 4.045 2.289 5.534a7.801 7.801 0 0 0 5.533 2.288c1.778 0 3.467-.6 4.845-1.688L18.71 20 20 18.711zM3.578 12.067c-2.334-2.334-2.334-6.156 0-8.49a5.968 5.968 0 0 1 4.244-1.755c1.6 0 3.111.622 4.245 1.756 2.333 2.333 2.333 6.155 0 8.489a5.968 5.968 0 0 1-4.245 1.755c-1.6 0-3.11-.622-4.244-1.755z' fill='%23" . $accent_color_pure . "'/%3E%3C/svg%3E\"); }";

...
function inis_b_custom_color_image($pageID) {
	...
	if (isset($tribe_customizer['global_elements']['accent_color'])) {
		...
		$output .= "\t.tribe-events .tribe-events-c-ical__link { color: " . $tribe_customizer['global_elements']['accent_color'] . "; border-color: " . $tribe_customizer['global_elements']['accent_color'] . "; }";

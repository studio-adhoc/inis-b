...
function inis_b_scripts() {
	...
	wp_enqueue_style( 'inis-b-style', get_bloginfo('template_directory').'/assets/css/style.css', array(),'1.' . strtotime(date('Y-m-d H:i')), 'all' );
	...
	wp_enqueue_script( 'is-it-check', get_bloginfo('template_directory').'/assets/js/is-it-check.min.js', array( 'jquery' ), '1.1', true );
	wp_enqueue_script( 'inis-b-functions', get_bloginfo('template_directory').'/assets/js/functions.js', array( 'jquery','is-it-check' ), '1.1', true );
}
